...
namespace RPG
{
    ...
    static class Fonts
    {
        ...
        public static void LoadContent(ContentManager contentManager)
        {
            ...
            buttonNamesFont = contentManager.Load<SpriteFont>("Fonts/Comic Sans MS");
            captionFont = contentManager.Load<SpriteFont>("Fonts/Comic Sans MS");
            damageFont = contentManager.Load<SpriteFont>("Fonts/Comic Sans MS");
            debugFont = contentManager.Load<SpriteFont>("Fonts/Comic Sans MS");
            descriptionFont = contentManager.Load<SpriteFont>("Fonts/Comic Sans MS");
            gearInfoFont = contentManager.Load<SpriteFont>("Fonts/Comic Sans MS");
            headerFont = contentManager.Load<SpriteFont>("Fonts/Comic Sans MS");
            hudDetailFont = contentManager.Load<SpriteFont>("Fonts/Comic Sans MS");
            playerNameFont = contentManager.Load<SpriteFont>("Fonts/Comic Sans MS");
            playerStatisticsFont =
                contentManager.Load<SpriteFont>("Fonts/Comic Sans MS");
